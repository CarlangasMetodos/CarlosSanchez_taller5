...
float *q1new= new float[dim];
float *q2new= new float[dim];
float *p1new= new float[dim];
float *p2new= new float[dim];
...
q1new[i]=q1[i]+(dt*(k1_q1+2.0*k2_q1+2.0*k3_q1+k4_q1)/6.0);
...
q2new[i]=q2[i]+(dt*(k1_q2+2.0*k2_q2+2.0*k3_q2+k4_q2)/6.0);
...
p1new[i]=p1[i]+(dt*(k1_p1+2.0*k2_p1+2.0*k3_p1+k4_p1)/6.0);
...
p2new[i]=p2[i]+(dt*(k1_p1+2.0*k2_p1+2.0*k3_p1+k4_p2)/6.0);
